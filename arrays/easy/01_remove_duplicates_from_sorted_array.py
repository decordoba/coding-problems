...
class Solution:
    def removeDuplicates_offset(self, nums: List[int]) -> int:
        """Use offset to track position to paste current number."""
        offset = 0
    ...
    def removeDuplicates_two_indices(self, nums: List[int]) -> int:
        """Use two indices to track position to paste current number."""
        idx = 0
        prev = None
